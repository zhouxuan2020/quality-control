...
Code for the good GWAS can be found in section \@ref(good). Basically, we used 100k unrelated white individuals with proper quality-controlled genotype data for the GWASs. We then did inflation tests using ldsc, sumher and the proposed method (based on individual level data using Haseman Elston regression)
...
Code for the bad GWAS can be found in section \@ref(bad). Basically, we used 100k unrelated individuals that consist of 93,528 whites and 6,472 blacks and Asians (i.e., mixed populations). Hence, the GWAS was confounded by population stratification. We conducted GWASs and did inflation tests using ldsc, sumher and the proposed method (based on individual level data using Haseman Elston regression)
