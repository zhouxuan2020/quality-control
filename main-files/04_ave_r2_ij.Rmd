...
# Does choice of SNPs matter? --------------------------------------------------
n= "6k"
m="10k"
dir="inflation/sensitivity/maf.1/"
nm=paste0("maf-g.1-",m,"-snps-mix-pop-",n,"-noneuro") # maf > .1
dat1=read.table(paste0(dir,"summary/ave-r2-",nm),stringsAsFactors = F) # 1st run
dat2=read.table(paste0(dir,"summary-run2/ave-r2-",nm),stringsAsFactors = F) # 2nd run

start=min(c(dat1$V2,dat2$V2))
end=max(c(dat1$V2,dat2$V2))
    
png("fig/aver2-1st-vs-2nd-run.png", res=600, width=30, height=20, units="cm")
par(cex.lab=1.2, font.lab=2, cex.main=1.5, pty="s")
plot(dat1$V2, dat2$V2,
     xlab="ave r2 using list1", ylab="ave r2 using snp list2",
     main=" list 1 vs. list 2", 
     xlim=c(start, end), ylim=c(start, end),
     cex = 1.5, pch=21,  bg="darkgray", col="white", lwd=0.5)
abline(0, 1, col="orange", lwd=1.5, lty=1)
points(dat1$V2, dat2$V2,cex = 1.5, pch=21,  bg="darkgray", col="white", lwd=0.5)
dev.off()
...
m2="1k"
dir="inflation/sensitivity/maf.1/"
nm1=paste0("maf-g.1-",m1,"-snps-mix-pop-",n,"-noneuro") # maf > .1
nm2=paste0("maf-g.1-",m2,"-snps-mix-pop-",n,"-noneuro") # maf > .1
dat1=read.table(paste0(dir,"summary/ave-r2-",nm1),stringsAsFactors = F) # based on 10k snps
dat2=read.table(paste0(dir,"summary/ave-r2-",nm2),stringsAsFactors = F) # based on 1k snps

start=min(c(dat1$V2,dat2$V2))
end=max(c(dat1$V2,dat2$V2))
    
png("fig/aver2-1k-vs-10k-snps.png", res=600, width=30, height=20, units="cm")
par(cex.lab=1.2, font.lab=2, cex.main=1.5, pty="s")
plot(dat1$V2, dat2$V2,
     xlab="ave r2 using 10k snps", ylab="ave r2 using 1k snps",
     main=" 1k vs. 10k SNPs", 
     xlim=c(start, end), ylim=c(start, end),
     cex = 1.5, pch=21,  bg="darkgray", col="white", lwd=0.5)
abline(0, 1, col="orange", lwd=1.5, lty=1)
...
m="10k"
dir="inflation/sensitivity/maf.1/"
nm1=paste0("maf-g.1-",m,"-snps-mix-pop-",n,"-noneuro") # maf > .1
nm2=paste0("maf-l.1-",m,"-snps-mix-pop-",n,"-noneuro") # maf < .1
dat1=read.table(paste0(dir,"summary/ave-r2-",nm1),stringsAsFactors = F) 
dat2=read.table(paste0(dir,"summary/ave-r2-",nm2),stringsAsFactors = F) 

start=min(c(dat1$V2,dat2$V2))
end=max(c(dat1$V2,dat2$V2))
    
png("fig/aver2-maf.1-g-vs-l.png", res=600, width=30, height=20, units="cm")
par(cex.lab=1.2, font.lab=2, cex.main=1.5, pty="s")
plot(dat1$V2, dat2$V2,
     xlab="ave r2 using MAF >.1 snps", ylab="ave r2 using MAF <.1 snps",
     main=" MAF >.1 vs. MAF <.1 SNPs", 
     xlim=c(start, end), ylim=c(start, end),
     cex = 1.5, pch=21,  bg="darkgray", col="white", lwd=0.5)
abline(0, 1, col="orange", lwd=1.5, lty=1)
points(dat1$V2, dat2$V2,cex = 1.5, pch=21,  bg="darkgray", col="white", lwd=0.5)
